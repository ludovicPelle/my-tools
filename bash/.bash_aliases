...
alias django-sync-database="rm -rf tagcloud/migrations/* && rm -rf osculteo/migrations/* && rm -rf payment/migrations/* && rm -rf authentication/migrations/* && ./manage.py makemigrations osculteo payment tagcloud authentication && ./manage.py migrate && ./manage.py load_fixtures && ./manage.py install_phantomjs && ./manage.py install_chromedriver"
alias django-start-api="./manage.py redis_build_conf && ./manage.py rabbitmqctl restart && ./manage.py redisctl stop && ./manage.py redisctl start && ./manage.py celeryctl restart w1 w2 && ./manage.py runserver_plus && node ./zoltan/build/server.js"
