...
alias dc-load-data="docker-compose run web bash -c \"python manage.py load_initial_data && python manage.py load_fixtures && python manage.py load_web_categories && python manage.py create_agency && python manage.py add_offers && python manage.py add_achievements && python manage.py add_real_quizzes && python manage.py create_b2b && python manage.py create_bereavement && python manage.py display_client_ids && python manage.py create_stripe_plans && python manage.py load_document_categories\""
...
function startJob {
    wmctrl -s 0;
    mate-terminal --window --maximize --working-directory="/home/loodub/Projects/fwc"  -e "bash -c 'git edit';bash"
    wmctrl -s 1;

    /opt/google/chrome/google-chrome --profile-directory=Default --app-id=dmmneannhefdfnmkfheapickfaialefp;

    wmctrl -s 2;
    mate-terminal  --window --maximize --working-directory="/home/loodub/Projects/fwc"  -e "bash -c 'gulp serve-dev --env env_ludo.json';bash"
    mate-terminal  --window --maximize --working-directory="/home/loodub/Projects/api_ng"  -e "bash -c 'docker-compse up;bash"
    wmctrl -s 3;
    thunderbird &
    slack &
